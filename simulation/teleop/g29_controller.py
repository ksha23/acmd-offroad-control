...
# Deliver wheel events regardless of window focus: the fullscreen sensor
# window may spawn unfocused, and without this hint SDL pauses joystick
# input until the operator clicks the window (observed live).
_os_env.environ.setdefault("SDL_JOYSTICK_ALLOW_BACKGROUND_EVENTS", "1")
import numpy as np
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            for i in range(num_joysticks):
                ...
                elif chosen_index is None and any(x in name.upper() for x in ['G27', 'G920', 'G923', 'LOGITECH']):
                    chosen_index = i
